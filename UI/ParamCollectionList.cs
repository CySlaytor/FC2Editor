...
namespace FC2Editor.UI
{
    internal class ParamCollectionList : UserControl
    {
        ...
        private void UpdateList()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                CollectionInventory.Entry entry = CollectionManager.GetCollectionEntryFromId(i);
                string iconKey;
                string text;
                if (entry.IsValid)
                {
                ...
                CollectionTreeItem tag = new CollectionTreeItem(i, entry);
        ...
        {
            CollectionTreeItem item = (treeView.SelectedNode != null) ? ((CollectionTreeItem)treeView.SelectedNode.Tag) : null;
            if (item != null)
            {
                buttonAssign.Enabled = true;
                buttonClear.Enabled = item.Entry.IsValid;
            }
            else
            {
        ...
        private CollectionTreeItem GetCurrentItem()
        {
            ...
            return (CollectionTreeItem)treeView.SelectedNode.Tag;
        }
        ...
        {
            CollectionTreeItem currentItem = GetCurrentItem();
        ...
        private void AssignToSelected()
        {
            ...
            using (PromptInventory promptInventory = new PromptInventory())
            {
                ...
                {
                    AssignCollectionId(currentItem.Id, (CollectionInventory.Entry)promptInventory.Value);
                }
            }
        }
        ...
        private void buttonClear_Click(object sender, EventArgs e)
        {
            ...
            if (currentItem != null)
            {
                AssignCollectionId(currentItem.Id, CollectionInventory.Entry.Null);
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.treeView.Size = new System.Drawing.Size(212, 174);
            ...
            this.Name = "ParamCollectionList";
            this.Size = new System.Drawing.Size(218, 225);
            this.Load += new System.EventHandler(this.ParamCollectionList_Load);
